...
For an example step-by-step deployment plan for outbound user provisioning to an application, see the [Identity Deployment Plan for User Provisioning](https://aka.ms/userprovisioningdeploymentplan).
