...
- [Migrate from AD FS to Pass-through Authentication](https://ADFSTOPTADP) - A detailed guide to migrate from AD FS (or other federation technologies) to Pass-through Authentication.
