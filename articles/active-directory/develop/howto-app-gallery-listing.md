...
- For automatic user-provisioning requests, the application should be listed in the gallery. You can request for SSO and User provisioning together on the portal, if it's not already listed.
